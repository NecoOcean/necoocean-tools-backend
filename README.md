...
《系统设计文档》开发顺序已在本地完成前七步。第 7 步后台已实现工具、分类、更新日志、文件元信息、留言管理和站点设置（C-13～C-27、C-30～C-32、C-34～C-41、C-43～C-47）。COS 相关的 C-28、C-29、C-33 和导出 C-42 留给后面。`GET /download/{file_id}` 在对象存储接入前对已上架文件仍返回 `40405`。下一步是对象存储直传。
